...
export default function StudyLogsPage() {
  ...
  return <><PageHeader title="Study history" description={description} actions={<Button render={<Link to="/add-log" />}><Plus data-icon="inline-start" /> Add log</Button>} /><Card><CardContent className="pt-0"><StudyLogList logs={logs} isActiveRecord={isActiveRecord} onEdit={(log) => navigate(`/add-log?id=${log.id}`)} /></CardContent></Card></>
}
