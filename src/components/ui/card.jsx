...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "group/card flex flex-col gap-4 overflow-hidden rounded-2xl border border-border bg-card py-4 text-sm text-card-foreground shadow-[0_1px_2px_rgba(16,22,47,0.03)] data-[size=sm]:gap-3 data-[size=sm]:py-3",
        className
      )}
      {...props} />
  );
