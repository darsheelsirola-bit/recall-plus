import { GROQ_PROVIDER, NVIDIA_PROVIDER } from './config.js'
...
export function logAiCall({
  ...
  if (!success) entry.errorCategory = provider === GROQ_PROVIDER ? errorCategory(error).replace('nvidia', 'groq') : errorCategory(error)
