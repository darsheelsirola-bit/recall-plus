...
assert.equal(packageMetadata.version, '7.18.3', 'react-router-dom must stay pinned to the reviewed version')
...
console.log('React Router compatibility passed: 7.18.3 exports and declarative SPA matching/rendering are available.')
