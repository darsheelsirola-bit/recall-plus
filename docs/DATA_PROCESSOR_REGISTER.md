...
| NVIDIA NIM | Curriculum/study context in prompts | Quiz / timetable / insights / recall generation | Provider cloud | No API key in browser; minimise personal data in prompts |
